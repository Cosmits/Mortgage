(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const l of r)if(l.type==="childList")for(const d of l.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&o(d)}).observe(document,{childList:!0,subtree:!0});function n(r){const l={};return r.integrity&&(l.integrity=r.integrity),r.referrerPolicy&&(l.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?l.credentials="include":r.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function o(r){if(r.ep)return;r.ep=!0;const l=n(r);fetch(r.href,l)}})();var B=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function D(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var W="Expected a function",P=0/0,X="[object Symbol]",G=/^\s+|\s+$/g,U=/^[-+]0x[0-9a-f]+$/i,V=/^0b[01]+$/i,z=/^0o[0-7]+$/i,J=parseInt,K=typeof B=="object"&&B&&B.Object===Object&&B,Q=typeof self=="object"&&self&&self.Object===Object&&self,Y=K||Q||Function("return this")(),Z=Object.prototype,ee=Z.toString,te=Math.max,ne=Math.min,j=function(){return Y.Date.now()};function ae(e,t,n){var o,r,l,d,c,u,b=0,S=!1,k=!1,E=!0;if(typeof e!="function")throw new TypeError(W);t=N(t)||0,F(n)&&(S=!!n.leading,k="maxWait"in n,l=k?te(N(n.maxWait)||0,t):l,E="trailing"in n?!!n.trailing:E);function T(s){var m=o,p=r;return o=r=void 0,b=s,d=e.apply(p,m),d}function q(s){return b=s,c=setTimeout(y,t),S?T(s):d}function H(s){var m=s-u,p=s-b,A=t-m;return k?ne(A,l-p):A}function M(s){var m=s-u,p=s-b;return u===void 0||m>=t||m<0||k&&p>=l}function y(){var s=j();if(M(s))return O(s);c=setTimeout(y,H(s))}function O(s){return c=void 0,E&&o?T(s):(o=r=void 0,d)}function R(){c!==void 0&&clearTimeout(c),b=0,o=u=r=c=void 0}function $(){return c===void 0?d:O(j())}function w(){var s=j(),m=M(s);if(o=arguments,r=this,u=s,m){if(c===void 0)return q(u);if(k)return c=setTimeout(y,t),T(u)}return c===void 0&&(c=setTimeout(y,t)),d}return w.cancel=R,w.flush=$,w}function F(e){var t=typeof e;return!!e&&(t=="object"||t=="function")}function ie(e){return!!e&&typeof e=="object"}function oe(e){return typeof e=="symbol"||ie(e)&&ee.call(e)==X}function N(e){if(typeof e=="number")return e;if(oe(e))return P;if(F(e)){var t=typeof e.valueOf=="function"?e.valueOf():e;e=F(t)?t+"":t}if(typeof e!="string")return e===0?e:+e;e=e.replace(G,"");var n=V.test(e);return n||z.test(e)?J(e.slice(2),n?2:8):U.test(e)?P:+e}var re=ae;const se=D(re);function L(e,t){const n=e.map(o=>`
        ...
        </li>`);t.bankList.innerHTML=n.join(" ")}function I(e,t){e.length>5?(t.divRoot.before(t.inputForFindBank),t.inputForFindBank.type="text",t.inputForFindBank.name="findBank",t.inputForFindBank.placeholder="Enter bank name for search ..",t.inputForFindBank.classList.add("js-inputForFindBank","bankItems"),t.inputForFindBank.classList.remove("hidden")):t.inputForFindBank.classList.add("hidden")}function le(e){let t=`
    <svg class="bank-icon"  width="24" height="24">
      <use href="./img/javascript.svg#icon-library" width="24" height="24"></use>
    </svg>`;e.addBankBtn.insertAdjacentHTML("afterbegin","<p>Add bank</p>"),e.addBankBtn.setAttribute("class","bank-items-btn"),e.addBankBtn.setAttribute("type","button"),e.addBankBtn.insertAdjacentHTML("beforeend",t),e.bottomContainerBtn.append(e.addBankBtn)}function de(e){let t=`
    <svg class="bank-icon"  width="24" height="24">
      <use href="./img/javascript.svg#icon-bin2" width="24" height="24"></use>
    </svg>`;e.clearBankBtn.insertAdjacentHTML("beforeend",t),e.clearBankBtn.insertAdjacentHTML("afterbegin","<p>Clear</p>"),e.clearBankBtn.classList.add("bank-items-btn"),e.clearBankBtn.classList.add("hidden"),e.clearBankBtn.setAttribute("type","button"),e.bottomContainerBtn.append(e.clearBankBtn)}function ce(){return`
