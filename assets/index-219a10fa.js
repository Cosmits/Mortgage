(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const d of r)if(d.type==="childList")for(const l of d.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&o(l)}).observe(document,{childList:!0,subtree:!0});function t(r){const d={};return r.integrity&&(d.integrity=r.integrity),r.referrerPolicy&&(d.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?d.credentials="include":r.crossOrigin==="anonymous"?d.credentials="omit":d.credentials="same-origin",d}function o(r){if(r.ep)return;r.ep=!0;const d=t(r);fetch(r.href,d)}})();var B=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function D(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var W="Expected a function",P=0/0,X="[object Symbol]",G=/^\s+|\s+$/g,U=/^[-+]0x[0-9a-f]+$/i,V=/^0b[01]+$/i,z=/^0o[0-7]+$/i,J=parseInt,K=typeof B=="object"&&B&&B.Object===Object&&B,Q=typeof self=="object"&&self&&self.Object===Object&&self,Y=K||Q||Function("return this")(),Z=Object.prototype,ee=Z.toString,ne=Math.max,te=Math.min,j=function(){return Y.Date.now()};function ae(e,n,t){var o,r,d,l,c,u,b=0,S=!1,k=!1,E=!0;if(typeof e!="function")throw new TypeError(W);n=N(n)||0,x(t)&&(S=!!t.leading,k="maxWait"in t,d=k?ne(N(t.maxWait)||0,n):d,E="trailing"in t?!!t.trailing:E);function T(s){var m=o,p=r;return o=r=void 0,b=s,l=e.apply(p,m),l}function q(s){return b=s,c=setTimeout(v,n),S?T(s):l}function H(s){var m=s-u,p=s-b,A=n-m;return k?te(A,d-p):A}function M(s){var m=s-u,p=s-b;return u===void 0||m>=n||m<0||k&&p>=d}function v(){var s=j();if(M(s))return O(s);c=setTimeout(v,H(s))}function O(s){return c=void 0,E&&o?T(s):(o=r=void 0,l)}function R(){c!==void 0&&clearTimeout(c),b=0,o=u=r=c=void 0}function $(){return c===void 0?l:O(j())}function w(){var s=j(),m=M(s);if(o=arguments,r=this,u=s,m){if(c===void 0)return q(u);if(k)return c=setTimeout(v,n),T(u)}return c===void 0&&(c=setTimeout(v,n)),l}return w.cancel=R,w.flush=$,w}function x(e){var n=typeof e;return!!e&&(n=="object"||n=="function")}function ie(e){return!!e&&typeof e=="object"}function oe(e){return typeof e=="symbol"||ie(e)&&ee.call(e)==X}function N(e){if(typeof e=="number")return e;if(oe(e))return P;if(x(e)){var n=typeof e.valueOf=="function"?e.valueOf():e;e=x(n)?n+"":n}if(typeof e!="string")return e===0?e:+e;e=e.replace(G,"");var t=V.test(e);return t||z.test(e)?J(e.slice(2),t?2:8):U.test(e)?P:+e}var re=ae;const se=D(re);function L(e,n){const t=e.map(o=>`
    ...
    `}function F(e,n){const t=ge(e);n.itemBankContainerEl.innerHTML=t}function he(e){if(e.target.nodeName==="UL")return;const n=e.target.closest(".bankItems").dataset.id;F(g(n,i),a)}function ve(e){let n=[];const t=e.target.value.trim();t.length>=2?n=ke(t,i):n=i,a.bankList.innerHTML="",L(n,a)}let f={},y="";function Be(e){e.target.closest(".bank-items-btn")!==null&&e.target.closest(".bank-items-btn").innerText==="Edit"&&(y=e.target.closest(".bankItems").dataset.id,f={...g(y,i)},_())}function ye(e){e.insertAdjacentHTML("beforeend",C("save","SAVE")),e.insertAdjacentHTML("beforeend",C("exit","EXIT"))}function Le(){const e=document.querySelectorAll(".bank-info-text"),n=Object.keys(f).slice(1);e.forEach((t,o)=>t.insertAdjacentHTML("beforeend",C(n[o],"Change")))}function C(e,n){return`<button type="button" class="changeBtn" id="${e}">${n}</button>`}function _(){const e=document.querySelector(".bank-info");Le(),ye(e),e.addEventListener("click",Ee)}function Ee(e){const n=e.target.closest(".changeBtn");if(n!==null&&e.target.innerText!=="SAVE"&&e.target.innerText!=="EXIT"){const t=n.getAttribute("id");let o=prompt("Введіть нове значення");if(o===null||o==="")return;t!=="name"&&(o=Number(o)),f[t]=o,F(f,a),_()}else e.target.innerText==="SAVE"?(i.splice(i.indexOf(g(y,i)),1,f),a.bankList.innerHTML="",a.itemBankContainerEl.innerHTML="",L(i,a),h("Banks",i)):e.target.innerText==="EXIT"&&(f={...g(y,i)},F(f,a))}function Te(e){if(e.target.closest(".bank-items-btn")!==null&&e.target.closest(".bank-items-btn").innerText==="Delete"){const n=e.target.closest(".bankItems").dataset.id,t=pe(n,i);console.log(t),i.splice(t,1),a.itemBankContainerEl.innerHTML="",h("Banks",i),I(i,a),L(i,a)}}function we(e){e.bankList.children.length>3?e.clearBankBtn.classList.remove("hidden"):e.clearBankBtn.classList.add("hidden")}function je(e){e.preventDefault(),document.querySelector(".js-modal").classList.remove("is-show"),document.querySelector(".js-modal-overlay").classList.remove("is-show")}function xe(){document.body.addEventListener("keyup",function(e){e.keyCode==27&&(document.querySelector(".js-modal").classList.remove("is-show"),document.querySelector(".js-modal-overlay").classList.remove("is-show"))},!1)}function Fe(){document.querySelector(".js-modal").classList.remove("is-show"),this.classList.remove("is-show")}function Ce(e){const{elements:{bankName:n,interestRate:t,maxLoan:o,minPayment:r,loanTerm:d}}=e.target,l={id:String(Date.now()),name:n.value.trim(),interestRate:Number(t.value),maxLoan:Number(o.value),minPayment:Number(r.value),loanTerm:Number(d.value)};i.splice(i.length,0,l),h("Banks",i)}const Ie=new Promise((e,n)=>{fe("Banks")||h("Banks",i),e(!0)});Ie.then(e=>{a.banksListContainerEl.classList.add("banksListContainer"),a.itemBankContainerEl.classList.add("itemBankContainer"),a.bankList.classList.add("bankList"),a.bottomContainerBtn.classList.add("bank-btn-wrap"),a.divRoot.append(a.banksListContainerEl,a.itemBankContainerEl,a.modalForm),a.banksListContainerEl.append(a.bankList,a.bottomContainerBtn),I(i,a),L(i,a),de(a),le(a),we(a),me(a),a.inputForFindBank.addEventListener("input",se(ve,500)),a.bankList.addEventListener("click",he),a.bankList.addEventListener("click",Be),a.bankList.addEventListener("click",Te),a.addBankBtn.addEventListener("click",ue),a.clearBankBtn.addEventListener("click",be),document.querySelector(".js-close-modal").addEventListener("click",je),document.querySelector(".form").addEventListener("submit",Ce),xe(),document.querySelector(".overlay").addEventListener("click",Fe)});
